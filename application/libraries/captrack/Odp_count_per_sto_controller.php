...
/**
* Json library
* @class Odp_count_per_sto_controller
...
class Odp_count_per_sto_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('captrack/odp_count_per_sto');
            $table = $ci->odp_count_per_sto;
            ...
            $data['success'] = true;
            logging('view data odp count per sto');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data odp count per sto');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data odp count per sto');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data odp count per sto');
            $table->db->trans_commit(); //Commit Trans
